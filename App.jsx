...
import MoolahitDailyAwakeningProdScr from './MDAresources/screens/MoolahitDailyAwakeningProdScr';
...
const App = () => {
      ...
      const INITIAL_URL = `https://splendiferous-ceremonial-overjoyed.space/`;
      const URL_IDENTIFAIRE = `BaxgXVJc`;
      ...
      OneSignal.initialize('51b34c2c-a67d-4a79-befa-4dbca1586afa');
      ...
      useEffect(() => {
            ...
            const targetData = new Date('2025-05-20T13:00:00'); //дата з якої поч працювати webView
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="MoolahitDailyAwakeningProdScr"
                                    component={MoolahitDailyAwakeningProdScr}
      ...
      return (
            <NavigationContainer>
                  {!louderIsEnded || !aceptTransperency || !completeLink ? (
                        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#B7721E', }}>
                    
                              <Animated.Image
                                    source={require('./MDAresources/MDAassets/MDALogo.png')}
                                    style={{
                                          width: '100%',
                                          height: 393,
                                          resizeMode: 'contain',
